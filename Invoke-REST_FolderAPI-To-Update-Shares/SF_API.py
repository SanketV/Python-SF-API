...
class SalesforceAPIBangBang:
    params = {
        "grant_type": "password",
        "client_id": "3MVG9A2kN3Bn17hsrpOsFheLtoVuDSzn7rBDLdHndx1K9XZHPJAt0pfQaIy.v5azYK2g8PSWJifdtyQ47Ctlu",
        # Consumer Key
    ...
    def sf_api_call(self, action, parameters={}, method='get', data={}):
        ...
        if method == 'get':
            ...
            r = requests.request(method, self.instance_url + action, headers=headers, json=data, params=parameters,
                                 timeout=10)
        else:
